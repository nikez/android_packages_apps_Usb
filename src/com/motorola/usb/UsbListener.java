...
public final class UsbListener implements Runnable
{
    ...
    public void run() {
        while (mRunning) {
		    ...
		    /* Hack until someone locates why stop is not triggered when unchecking USB Thethering */
		    Log.w(TAG, "I/O error in socket communication, force closing the connection!", e);
		    stop();
                }
            } catch (Exception e) {
